export const translations = {
  "en": {
    ...
    "admin": {
      ...
      "authorHy": "Author (Armenian)",
      "description": "Description",
      "descriptionEn": "Description (English)",
      "descriptionHy": "Description (Armenian)",
      "content": "Content",
      "contentEn": "Content (English)",
      "contentHy": "Content (Armenian)",
      "category": "Category",
      ...
      "instructorEn": "Instructor (English)",
      "instructorHy": "Instructor (Armenian)",
  ...
  "hy": {
    ...
    "admin": {
      ...
      "zoomLink": "Zoom հղում",
      "instructor": "Վարորդ",
      "instructorEn": "Վարորդ (Անգլերեն)",
      "instructorHy": "Վարորդ (Հայերեն)",
      "donorName": "Նվիրողի Անուն",
      "amount": "Գումար",
      "message": "Հաղորդագրություն",
      "anonymous": "Անանուն",
      "noItems": "Էլեմենտներ չկան",
      "english": "English",
      "armenian": "Armenian (Հայերեն)"
    },
    "contacts": {
...
type Admin = { 
  ...
  videoUrl: string; youtubeId: string; duration: string; pptxUrl: string; date: string; time: string;
  zoomLink: string; instructor: string; instructorEn: string; instructorHy: string;
