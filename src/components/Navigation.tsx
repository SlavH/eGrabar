          ...
          <div className="flex rounded-lg overflow-hidden border border-white/20 relative z-[120]">
            <button
              ...
              className={`px-2 py-1 text-xs font-medium transition-colors ${
                language === 'hy' ? 'bg-blue-600 text-white' : 'text-slate-300 hover:text-blue-600'
              }`}
            >
              ՀԱ
            </button>
            <button
              ...
              className={`px-2 py-1 text-xs font-medium transition-colors ${
                language === 'en' ? 'bg-blue-600 text-white' : 'text-slate-300 hover:text-blue-600'
              }`}
            >
              ENG
            </button>
