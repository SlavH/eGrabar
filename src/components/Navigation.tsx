      ...
      >
        <div className="max-w-[90rem] mx-auto px-6 flex items-center justify-between relative">
          <Link href="/" className="flex items-center gap-1.5 group relative z-[120]">
            ...
            <span className="text-xl sm:text-2xl font-semibold tracking-wide whitespace-nowrap">
              <span className="text-blue-200 text-lg sm:text-2xl">{language === 'en' ? 'eGrabar' : 'Գրաբար'}</span>
            </span>
          </Link>
