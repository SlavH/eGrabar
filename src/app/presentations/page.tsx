...
const mockPresentations: Presentation[] = [
  { id: '1', title: 'Armenian Architectural Heritage', description: 'Deep dive into medieval stonework.', thumbnail_url: '', pptx_url: '', created_at: new Date().toISOString(), views: 50 },
  { id: '2', title: 'Digitalization of Manuscripts', description: 'Techniques and challenges.', thumbnail_url: '', pptx_url: '', created_at: new Date().toISOString(), views: 30 },
];
